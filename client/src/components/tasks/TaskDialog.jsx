  ...
  return (
    <>
      <Menu as='div' className='relative inline-block text-left'>
        ...
        <CustomTransition>
          <Menu.Items className='absolute left-0 w-40 p-4 mt-2 bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black/5 focus:outline-none'>
...
export default function TaskDialog({ task }) {
  ...
  return (
    <>
      <div className=''>
        <Menu as='div' className='relative inline-block text-left'>
          <Menu.Button className='inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-600 rounded-md dark:text-gray-300'>
            <BsThreeDots />
          </Menu.Button>

          <CustomTransition>
            <Menu.Items className='absolute right-0 w-56 p-4 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black/5 focus:outline-none'>
              <div className='px-1 py-1 space-y-2'>
                {items.map((el, index) => (
